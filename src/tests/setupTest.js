...
const resultData = [
    ...
    {
        _id: new objectId('649fada43016797da5147e94'),
        name: 'Iker',
        email: 'iker@yomail.com',
        password:
            'ysM3MYQk84zRJ5hQ9UnWwA==.eqYTpp1O7C/iF7T3GPCN/yQ0fqwPfjggiYKrkvjc9vTd6VRgBgZ7+YQjO2vDjZOnYduxjR8zFHz0Y6vjTZ5BAQ==',
        salt: 'ysM3MYQk84zRJ5hQ9UnWwA==',
        verified: true,
        roles: 'borrower',
        phoneNumber: '089283822',
        createdDate: '1682308371168',
    ...
    {
        _id: new objectId('649fa6d7666b2f32b476f848'),
        name: 'Ronaldo',
        email: 'ronaldo@yopmail.com',
        phoneNumber: '628533360111',
        password:
            'F0TsrArsnh4HIYuZ3dkDIg==.eqYTpp1O7C/iF7T3GPCN/yQ0fqwPfjggiYKrkvjc9vTd6VRgBgZ7+YQjO2vDjZOnYduxjR8zFHz0Y6vjTZ5BAQ==',
        salt: 'FBIen/+u/lDCwjlw7oKAOQ==',
        verified: true,
        roles: 'borrower',
        birthDate: 'false',
        idCardNumber: 0,
